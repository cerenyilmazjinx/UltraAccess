...
#[derive(Debug)]
pub struct UltraAccessProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraAccessProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraAccess processing");
    
    let mut processor = UltraAccessProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraAccessProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraAccessProcessor::new(false);
